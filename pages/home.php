...
<body>
  ...
  <main>
    ...
    <div class="catalog">
      ...
      <section class="sidebar">
        ...
        <div class="filter-sort-form">
          <form id="filter-sort" method="get" action="/" novalidate>
            ...
            <!-- Sort section -->
            <div>
              <h3 class="form-heading">Sort by:</h3>
              <div class="sort-option">
                <input type="radio" name="sort" id="oldest" value="oldest" <?php echo $sticky_old_sort; ?> />
                <label for="oldest">Oldest to most recent entry (default)</label>
              </div>

              <div class="sort-option">
                <input type="radio" name="sort" id="recent" value="recent" <?php echo $sticky_recent_sort; ?> />
                <label for="recent">Most recent to oldest entry</label>
              </div>

              <div class="sort-option">
                <input type="radio" name="sort" id="alphabetical" value="alphabet" <?php echo $sticky_alphabet_sort; ?> />
                <label for="alphabetical">Alphabetical by colloquial name (A-Z)</label>
              </div>
            </div>
      ...
      <section class="table">
        <?php if ($show_filter_confirmation) { ?>
          <!-- confirmation after sorting/filtering, hidden by default -->
          <div class="confirmation">
            <?php if ($queries_matching == 1) { ?>
              1 result found.
            <?php } else { ?>
              <?php echo htmlspecialchars($queries_matching)?> results found.
            <?php } ?>
          </div>
        <?php } ?>
